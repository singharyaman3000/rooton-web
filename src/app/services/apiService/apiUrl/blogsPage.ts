...
const GET_BLOGS_LIST_WITH_SERVICETYPE_AND_BLOGTYPE =
  '/api/blogs/?populate[0]=media_url&populate[1]=author_profile_image.media_url&populate[2]=blog_contents.media_url&pagination[page]=<pageNo>&pagination[pageSize]=8&filters[service_type][$eq]=<serviceType>&filters[category][$eq]=<articleType>';
