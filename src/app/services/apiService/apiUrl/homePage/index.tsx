...
export const NEWS_ALERT_DATA_API = '/api/blogs/?populate[0]=media_url&populate[1]=author_profile_image.media_url&populate[2]=sub_service&filters[updatedAt][$gte]=<startDate>&filters[toBeFeatured][$eq]=true';
