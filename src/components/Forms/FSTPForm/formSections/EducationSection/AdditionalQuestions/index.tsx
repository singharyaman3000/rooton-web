...
import { AddEducationKeyMap, AdditionalPropsType } from '@/components/Forms/CECForm/config/models';
...
export const AdditionalQuestions = (props: AdditionalPropsType) => {
  ...
  return (
    <div className="relative border ml-8 my-4 p-4 py-10 border-solid border-[black]">
      <FormCloseButton
        onclick={() => {
          close(id);
        }}
