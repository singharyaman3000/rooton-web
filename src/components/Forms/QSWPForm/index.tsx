...
type QSWPFormParamsType = { title: string, leadFormRef: RefObject<HTMLDivElement>; formId: string; meetingLink: Record<string, string> };

const QSWPForm = ({ title, leadFormRef, formId, meetingLink }: QSWPFormParamsType) => {
  return (
