...
type CECFormParamsType = { title: string, leadFormRef: RefObject<HTMLDivElement>; formId: string, meetingLink: Record<string, string> };

const CECForm = ({ title, leadFormRef, formId, meetingLink }: CECFormParamsType) => {
  return (
