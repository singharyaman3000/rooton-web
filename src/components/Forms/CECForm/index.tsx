...
type CECFormParamsType = { leadFormRef: RefObject<HTMLDivElement>; formId: string, meetingLink: Record<string, string> };

const CECForm = ({ leadFormRef, formId, meetingLink }: CECFormParamsType) => {
  return (
