...
type FSWFormParamsType = { title: string, leadFormRef: RefObject<HTMLDivElement>; formId: string; meetingLink: Record<string, string> };

const FSWForm = ({ title, leadFormRef, formId, meetingLink }: FSWFormParamsType) => {
  return (
