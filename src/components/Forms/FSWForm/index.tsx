...
type FSWFormParamsType = { leadFormRef: RefObject<HTMLDivElement>; formId: string; meetingLink: Record<string, string> };

const FSWForm = ({ leadFormRef, formId, meetingLink }: FSWFormParamsType) => {
  return (
