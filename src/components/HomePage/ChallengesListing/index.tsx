...
const ChallengesListing = ({ title, sub_title, description, json_content, media_url }: IChallengesListing) => {
  ...
  return (
    <section className="challenges-listing max-w-screen-2k mx-auto my-0">
          ...
          <div className="md:w-[48.8%] md:pr-[80px]">
           ...
           "
            ...
            <Button
              ...
              cssClass="text-white !font-semibold !text-[14px] bg-black border-0 w-full md:w-auto justify-center !py-[17px] mt-5 mb-3 gap-[4px]"
              handleOnClick={() => {
                openCoreServiceList();
              }}
              tabIndex={0}
