...
const HonestyCard = ({ title, icon, value }: IWhyRootON) => {
  return (
    <div className="flex flex-col justify-center p-4 bg-primary">
      ...
      <h1 className="text-primary-font-color w-[70%] mb-4 text-xl font-bold leading-6 tracking-normal">{title} </h1>
