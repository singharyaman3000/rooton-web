...
const NewsLetter = () => {
  return (
    <SectionContainer cssClass="pt-10 pb-20 md:pt-0 md:pb-0">
      <div className=" relative md:mb-[52px] bg-pale-sandal  py-6 px-5 md:pt-16 md:pb-16 md:px-[52px] flex flex-col md:flex-row md:justify-between md:gap-x-[4%]  lg:pb-[110px]">
