...
const ArticleCard = ({ attributes, articleId }: ArticleCardPropType) => {
  ...
  return (
    <Link href={href}>
      <div className="flex flex-col px-6 md:px-0 justify-start items-center bg-white-fixed blog-bg h-[478px] lg:h-[527px] border-t-[1px] border-[#b9b9b9] md:border hover:border-golden-yellow !min-w-[360px] md:w-[380px] cursor-pointer">
