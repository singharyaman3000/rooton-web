            ...
            <FormDropdown
              ...
              onChange={(e) => {
                ...
                if (e.target.value !== 'British Columbia, Canada') {
                  ...
                  onchange('how_many_years_of_full_time__or_part_time_equivalent__work_experience_do_you_have_that_is_directly_', '');
                ...
                if (e.target.value !== 'Manitoba, Canada')
                  onchange('have_you_received_an_invitation_to_apply_from_the_manitoba_provincial_nominee_program_for_canadian_', '');
                if (e.target.value !== 'Alberta, Canada')
                  onchange('do_you_have_related_education__training__previous_work_experience_and_any_alberta_licensing_needed_', '');
          ...
          <div className="flex flex-col gap-4 md:grid grid-cols-2">
            ...
            {shouldShowAlberta() &&
              <FormRadioInput
                ...
                value={formData?.do_you_have_related_education__training__previous_work_experience_and_any_alberta_licensing_needed_}
                onChange={(e) => {
                  onchange('do_you_have_related_education__training__previous_work_experience_and_any_alberta_licensing_needed_', e.target.value);
                }}
              />
            }
            {shouldShowManitoba() &&
