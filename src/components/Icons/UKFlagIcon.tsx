        ...
        <g mask="url(#ufyv4pmw9b)">
          <g transform="translate(-8)">
            ...
            <g mask="url(#s7c07onwhd)">
              <path fill="#012169" fill-rule="nonzero" d="M0 0v16h32V0z" />
              <path d="m0 0 32 16m0-16L0 16" stroke="#FFF" stroke-width="3.2" fill="#000" fill-rule="nonzero" />
              ...
              <path
                ...
                mask="url(#8eoqt2qgpf)"
              />
              <path d="M16 0v16M0 8h32" stroke="#FFF" stroke-width="5.333" fill="#000" fill-rule="nonzero" />
              <path d="M16 0v16M0 8h32" stroke="#C8102E" stroke-width="3.2" fill="#000" fill-rule="nonzero" />
            </g>
          </g>
        </g>
      </g>
